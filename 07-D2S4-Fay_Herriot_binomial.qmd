...
knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Binomial1.PNG")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Binomial2.PNG")
```
...
```{r echo=FALSE,  out.width="400%",fig.align='center'}
 knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Binomial.PNG")
```
...
```{r echo=FALSE, out.width = "400%",fig.align='center'}
 knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Binomial_cv.PNG")
```
