...
```{r echo=FALSE, out.height= "200%",fig.align='center'}
 knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Beta1.PNG")
```
...
```{r echo=FALSE, out.height= "200%",fig.align='center'}
 knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Beta2.PNG")
```
...
```{r echo=FALSE,  out.height= "400%",fig.align='center'}
 knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Beta.PNG")
```
...
```{r echo=FALSE, out.height= "400%",fig.align='center'}
 knitr::include_graphics("Recursos/Día2/Sesion4/0Recursos/Beta_cv.PNG")
```
