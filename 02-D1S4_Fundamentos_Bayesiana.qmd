...
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Bernoulli/Bernoulli1.png")
```
...
# saveRDS(tabla_Ber1,
#         file = "Recursos/Día1/Sesion4/0Recursos/Bernoulli/tabla_Ber1.rds")
tabla_Ber1 <- readRDS("Recursos/Día1/Sesion4/0Recursos/Bernoulli/tabla_Ber1.rds") 
tabla_Ber1 %>% tba()
```
...
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Bernoulli/Bernoulli2.png")
```
...
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Bernoulli/Bernoulli3.png")
```
...
```{r echo=FALSE, , out.width="200%", fig.align='center'}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Bernoulli/Bernoulli4.png")
```
...
```{r, echo=FALSE}
# saveRDS(dataS,file = "Recursos/Día1/Sesion4/0Recursos/Binomial/dataS.rds")
dataS <-readRDS("Recursos/Día1/Sesion4/0Recursos/Binomial/dataS.rds")
tba(dataS)
```
...
```{r, echo=FALSE}
# saveRDS(tabla_Bin1, "Recursos/Día1/Sesion4/0Recursos/Binomial/tabla_Bin1.rds")
tabla_Bin1 <- readRDS("Recursos/Día1/Sesion4/0Recursos/Binomial/tabla_Bin1.rds")
tabla_Bin1 %>% tba()
```
...
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Binomial/Binomial1.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Binomial/Binomial2.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Binomial/Binomial3.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Normal/Normal1.png")
```
...
```{r, echo=FALSE}
# saveRDS(tabla_Nor1,
#         file = "Recursos/Día1/Sesion4/0Recursos/Normal/tabla_Nor1.rds")
tabla_Nor1 <- readRDS("Recursos/Día1/Sesion4/0Recursos/Normal/tabla_Nor1.rds")
tabla_Nor1 %>% tba() 
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Normal/Normal2.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Normal/Normal3.png")
```
...
```{r, echo=FALSE}
# saveRDS(tabla_Nor2, 
#         file = "Recursos/Día1/Sesion4/0Recursos/Normal/tabla_Nor2.rds")
tabla_Nor2 <- readRDS("Recursos/Día1/Sesion4/0Recursos/Normal/tabla_Nor2.rds")
tabla_Nor2 %>% tba() 
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Normal/Normal4.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Normal/Normal5.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Normal/Normal6.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Normal/Normal7.png")
```
...
```{r, echo=FALSE}
# saveRDS(dataMult, 
#         file = "Recursos/Día1/Sesion4/0Recursos/Multinomial/dataMult.rds")
dataMult <- readRDS( "Recursos/Día1/Sesion4/0Recursos/Multinomial/dataMult.rds")
tba(dataMult)
```
...
```{r, echo=FALSE}
# saveRDS(tabla_Mul1, 
#         file = "Recursos/Día1/Sesion4/0Recursos/Multinomial/tabla_Mul1.rds")
tabla_Mul1 <- readRDS("Recursos/Día1/Sesion4/0Recursos/Multinomial/tabla_Mul1.rds")
tabla_Mul1 %>% tba()
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Multinomial/Multinomial1.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Multinomial/Multinomial2.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Multinomial/Multinomial3.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Multinomial/Multinomial4.png")
```
...
```{r echo=FALSE, out.width="200%",fig.align='center'}
knitr::include_graphics("Recursos/Día1/Sesion4/0Recursos/Multinomial/ppc_multinomial.PNG")
```
