...
knitr::include_graphics("Recursos/Día2/Sesion3/0Recursos/FH_Asin.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día2/Sesion3/0Recursos/FH_Asin2.png")
```
...
knitr::include_graphics("Recursos/Día2/Sesion3/0Recursos/Mapa_arcoseno.PNG")
```
...
```{r echo=FALSE,  out.width="400%",fig.align='center'}
 knitr::include_graphics("Recursos/Día2/Sesion3/0Recursos/Mapa_arcoseno_cv.PNG")
```
