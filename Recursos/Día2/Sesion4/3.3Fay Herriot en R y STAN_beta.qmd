...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  cache = TRUE,
  cache.path = "0Recursos/3.3beta_logitc/",
  fig.path = "0Recursos/3.3beta_logitc/"
)
library(printr)
library(kableExtra)
library(tidyverse)
...
inner_join(
  readRDS("Data/predictors_censo_dam2.rds"),
...
posterior_sigma_v <- as.array(model_FH_beta_logitic, pars = "sigma_v")
