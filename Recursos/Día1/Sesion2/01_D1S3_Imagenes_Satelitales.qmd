...
```{r, eval=FALSE}
shape <- read_sf("Shape/CHL_dam2.shp")
#shape <- read_sf("Shape/CHL_dam.shp")
plot(shape["geometry"])
```


```{r, echo=FALSE}
include_graphics("0Recursos/CHL_1.png")
```
...
predictors_satelital <-
  readRDS("Data/satelitales_media_dam2.rds")
...
knitr::include_graphics("0Recursos/Luces_CHL_satelite.png")
```
...
knitr::include_graphics("0Recursos/suelo_cultivo_CHL.png")
```
...
knitr::include_graphics("0Recursos/suelo_urbanos_CHL.png")
```
...
knitr::include_graphics("0Recursos/modifica_humana_CHL.png")
```
...
knitr::include_graphics("0Recursos/tiempo_hospital.png")
 knitr::include_graphics("0Recursos/tiempo_hospital_CHL.png")
```
...
knitr::include_graphics("0Recursos/tiempo_hospital_no_motor_CHL.png")
```

### Vegetación NDVI 

```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("0Recursos/NDVI.png")
knitr::include_graphics("0Recursos/NDVI_CHL.png")
```

### Polución 

```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("0Recursos/pollution_CO.png")
knitr::include_graphics("0Recursos/pollution_CO_CHL.png")
```

### Temperatura del aire a 2 m sobre la superficie de la tierra, el mar o las aguas interiores. 

```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("0Recursos/Temperatura_2m.png")
knitr::include_graphics("0Recursos/Temperatura_2m_CHL.png")
```

### Temperatura del suelo en la capa 4 (100-289 cm) del Sistema Integrado de Pronóstico ECMWF.

```{r echo=FALSE, out.width = "500px", out.height="350px",fig.align='center'}
knitr::include_graphics("0Recursos/Temperatura_level_4 .png")
knitr::include_graphics("0Recursos/temperature_ECMWF_CHL.png")
```
