...
library(ggplot2)
library(dplyr)
encuesta_agregada <- readRDS("Recursos/Día3/Sesion1/Data/encuesta2017CHL.Rds") %>% 
  group_by(
...
knitr::include_graphics("Recursos/Día3/Sesion1/0Recursos/Bernoulli/plot_comp.png")
```
...
```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("Recursos/Día3/Sesion1/0Recursos/Ingreso.PNG")
```
...
```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("Recursos/Día3/Sesion1/0Recursos/Ingreso1.PNG")
```
...
```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("Recursos/Día3/Sesion1/0Recursos/Ingreso2.PNG")
```
...
```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("Recursos/Día3/Sesion1/0Recursos/Ingreso3.PNG")
```
...
ShapeSAE <- read_sf("Recursos/Día3/Sesion1/Shape/CHL_dam2.shp") 
...
knitr::include_graphics("Recursos/Día3/Sesion1/0Recursos/Map_CHL.PNG")
```
