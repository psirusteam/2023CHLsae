...
knitr::include_graphics("Recursos/Día4/Sesion2/0Recursos/FH1.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día4/Sesion2/0Recursos/FH2.png")
```
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día4/Sesion2/0Recursos/FH3.png")
```
...
```{r, echo=FALSE}
data_dir <- readRDS("Recursos/Día4/Sesion2/0Recursos/data_dir.rds")
data_syn <- readRDS("Recursos/Día4/Sesion2/0Recursos/data_syn.rds")
tba(data_syn %>% slice(1:10) %>%
      select(dam2:hat_var,theta_pred:Cv_theta_pred))
...
```{r echo=FALSE, out.width="200%"}
knitr::include_graphics("Recursos/Día4/Sesion2/0Recursos/FH4.png")
```
...
knitr::include_graphics("Recursos/Día4/Sesion2/0Recursos/Mapa_CHL_FIES_normal.PNG")
```
