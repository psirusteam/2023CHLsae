...
```{r, echo=FALSE}
indicador_dam1 <- readRDS("Recursos/Día4/Sesion1/Data/base_modelo.Rds")
...
knitr::include_graphics("Recursos/Día4/Sesion1/0Recursos/theta_ajustado.png")
```  
...
```{r echo=FALSE, out.width = "800px", out.height="200px",fig.align='center'}
knitr::include_graphics("Recursos/Día4/Sesion1/0Recursos/ppc.png")
```  
...
```{r, echo=FALSE}
estimaciones <- readRDS("Recursos/Día4/Sesion1/Data/estimaciones.rds")
tba(head(estimaciones,10))
```
...
```{r echo=FALSE, out.width = "800px", out.height="200px",fig.align='center'}
knitr::include_graphics("Recursos/Día4/Sesion1/0Recursos/Plot_Bench_gk.jpeg")
```  
...
```{r, echo=FALSE}
tablas <- readRDS("Recursos/Día4/Sesion1/0Recursos/tablas.rds")
tba(tablas)
...
```{r, echo=FALSE}
estimaciones <- readRDS("Recursos/Día4/Sesion1/Data/estimaciones_Bench.rds")
```
...
knitr::include_graphics("Recursos/Día4/Sesion1/0Recursos/Ocupados.png")
```
...
```{r echo=FALSE, out.width = "800%" , fig.align='center'}
knitr::include_graphics("Recursos/Día4/Sesion1/0Recursos/Desocupados.png")
```
...
```{r echo=FALSE, out.width = "800%", fig.align='center'}
knitr::include_graphics("Recursos/Día4/Sesion1/0Recursos/Inactivo.png")
```
